...
public sealed class IdempotentWriter
{
    ...
    public static string DeterministicId(string source, long sequence)
    {
        ...
        // id that nothing will ever reconcile. Pad the sequence to ten digits —
        // ids are strings, so "station-1-10" sorts before "station-1-9" without
        // it, and range queries on id quietly break. Normalise the source by
        // trimming it and lower-casing it invariantly.
        // See lessons/11-cosmos-development/README.md#retrying-safely-means-retrying-idempotently
        throw new NotImplementedException(
            "GAP 9: implement IdempotentWriter.DeterministicId. "
            + "See lessons/11-cosmos-development/README.md#retrying-safely-means-retrying-idempotently.");
    }
    ...
    public static RetrySafety Classify(StoreOperation operation, InterruptionKind interruption)
    {
        ...
        // See lessons/11-cosmos-development/README.md#retrying-safely-means-retrying-idempotently
        throw new NotImplementedException(
            "GAP 10: implement IdempotentWriter.Classify. "
            + "See lessons/11-cosmos-development/README.md#retrying-safely-means-retrying-idempotently.");
    }
    ...
    {
        // GAP 11: every unsafe operation has a safe sibling that expresses
        // the same intent.
        //
        ...
        // See lessons/11-cosmos-development/README.md#retrying-safely-means-retrying-idempotently
        throw new NotImplementedException(
            "GAP 11: implement IdempotentWriter.MakeSafe. "
            + "See lessons/11-cosmos-development/README.md#retrying-safely-means-retrying-idempotently.");
    }
}
