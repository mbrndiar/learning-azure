...
public sealed class CleanupPlanner
{
        ...
        bool expiryIsPredictable)
    {
        ...
        //
        // Deleting the container is free and instantaneous, but only if nothing
        // else lives in it — which is why "one container per concern" is an
        // operational decision as much as a modelling one. TTL is the next
        // best: the service spends leftover throughput on it, so the deletion
        // costs the application nothing it would otherwise have used.
        // Per-document deletion is last because it is the only one you pay for,
        // and its bill scales with the mistake. Give each plan a reason.
        // See lessons/11-cosmos-development/README.md#deleting-is-a-write
        throw new NotImplementedException(
            "GAP 14: implement CleanupPlanner.Plan. "
            + "See lessons/11-cosmos-development/README.md#deleting-is-a-write.");
    }
}
